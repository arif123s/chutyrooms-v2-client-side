          ...
          <div className="w-8/12">
            <div>
              <div
                ...
                className="flex items-center justify-between dropdown"
              >
                <p
                  className={`text-[18px] font-['Gilroy-semibold'] cursor-pointer ${
                ...
                >
                  How can I get more information about the room's or property's
                  facilities?
                </p>
                {openDropdownIndex === 1 ? (
                  <img
            ...
            <div>
              ...
              {openDropdownIndex === 2 && (
                <p className="mt-[18px] w-8/12">
                  ...
                  you still haven{"'"}t received it after that time, please
                  check your junk mail or spam filters. You can also download or
                  resend your booking voucher online.
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {openDropdownIndex === 4 && (
                <p className="mt-[18px] w-8/12">
                  If breakfast is included, it will display "Breakfast Included.
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {openDropdownIndex === 5 && (
                <p className="mt-[18px] w-8/12">
                  You can cancel your booking online on the ChutyRooms website
                  or app.
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {openDropdownIndex === 6 && (
                <p className="mt-[18px] w-8/12">
                  After you cancel a booking with us, you should receive an
                  email confirming the cancellation. Check your inbox and
                  spam/junk mail folders, or check the website.
                </p>
              )}
            </div>
