...
return (
  <div className="m-[24px] bg-white min-h-[600px]">
    <p className="p-[18px]">
      You don{"'"}t have any property yet! To add your property
      <Link className="ml-[4px] text-[#50b375]" to={"/dashboard/property-add"}>
        click here.
      </Link>
    </p>
  </div>
  ...
  return (
    <div className="country-list-content">
      <div className="country-list min-h-[700px]">
        ...
        {propertyData?.data?.pagination && <div className="pagination w-full">
          <img
            src={RightArrowUrl}
