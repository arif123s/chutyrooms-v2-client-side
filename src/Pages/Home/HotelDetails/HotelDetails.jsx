        ...
        <div className="hotel-details-section">
          <div className="hotel-information-details">
            <div className="iamge-gallery-div relative">
              ...
              >
                <a
                  href={searchData?.data?.hotels_data?.property_image[0].url}
                  className="hotels-large-image-link"
                >
                  <img
                    src={searchData?.data?.hotels_data?.property_image[0].url}
                    className="hotel-large-image"
                  ></img>
                </a>

                {searchData?.data?.hotels_data?.property_image?.map(
                  (img, index) => (
            ...
            <div className="hotel-info-division">
              <div className="hotel-info-with-price">
                <div>
                  ...
                  <div className="flex gap-x-2 mt-[5px]">
                    ...
                    <div>
                      <span className="chuty-property-id">CR000002CX</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-x-2">
                    ...
                    <div className="location-name">
                      {searchData?.data?.hotels_data.area},
                      {searchData?.data?.hotels_data.district}
                    </div>
                  </div>
                  ...
                  <div className="flex mt-[5px] space-x-[4px]">
                    ...
                    <div>{searchData?.data?.hotels_data.hotel_class}</div>
                  </div>
                  ...
                  <div className="flex gap-x-1  mt-[5px]">
                    ...
                    <div>
                      Number of Rooms{" "}
                      {searchData?.data?.hotels_data.number_of_rooms}
                    </div>
                  </div>
                  ...
                  <div className="flex gap-x-1  mt-[5px]">
                    ...
                    <div>
                      {" "}
                      Number of Floors
                      {searchData?.data?.hotels_data.number_of_floors}
                    </div>
                  </div>
                </div>

                <div className=" mt-[5px]">
                  <div className="hotel-regular-price">
                    BDT {searchData?.data?.hotels_data.rooms_regular_price}
                  </div>
                  <div className="chuty-offer-price">
                    BDT{" "}
                    {searchData?.data?.hotels_data.rooms_website_users_price}
                  </div>
              ...
              <div className="grid gap-x-[5px] gap-y-[5px] mt-[5px]">
                ...
                <div className="facility-division">
                  {searchData?.data?.hotels_data?.amenities?.map(
                    (amenities) => (
          ...
          <div className="hotel-info-menu-list">
            {lists.map((list, i) => (
              <a
                key={i}
                href={`#${list.id}`}
                onClick={() => ColorHandleClick(list.name)}
                className={`${
                  color == list.name
                    ? "onclick-setcolor"
                    : "onclicksetcancel-color"
                }`}
              >
                {list.name}
              </a>
          ...
          <div
            className="relative room-with-price-overview-division mt-[24px] z-1"
            id="CaregoriesOfRooms"
          >
            <div>
              {searchData?.data?.hotels_data?.rooms?.map((room, index) => (
                <div key={room.room_id} className="room-info-and-picture">
                  <div className="room-details">
                    <div className="room-information">
                      <div className="room-name-with-icon">
                        <div className="room-name  break-words">
                          {room.room_name}
                        </div>
                        <div className="flex ">
                      ...
                      <div className="grid gap-y-2 mt-[10px]">
                        <div className="flex  gap-x-1">
                          ...
                          />
                          <div>
                            {room.adult_guest_qty} Adults ,{" "}
                            {room.child_guest_qty} Child
                          </div>
                        </div>
                        <div className="flex gap-x-1">
                        ...
                        <div className="hurry-up-message">
                          Hurry up only 8 rooms left
                        </div>
                    ...
                    <div className="flex space-x-5">
                      <div className="flex space-x-2 items-center">
                        <div className="offer-price">
                          BDT {room.rooms_website_users_price}
                        </div>
                        <div className="rooms-regular-price mt-[1px]">
                          BDT {room.rooms_regular_price}
                        </div>
                      </div>
          ...
          <div className="facilities-container" id="facilities">
            ...
            {searchData?.data?.hotels_data?.facilities?.map(
              (amenities_category) => (
                <div key={amenities_category.id} className="grid gap-y-[5px]">
                  <div className="facility">{amenities_category.name}</div>
                  <div className="flex space-x-[10px]">
                    {amenities_category?.amenities?.map((amenities) => (
                      <div key={amenities.id} className="flex space-x-1">
          ...
          <div className="policy-container space-y-4" id="policy">
            ...
            <div className="grid grid-cols-4 ">
              ...
              <div className="font-semibold">
                {searchData?.data?.hotels_data?.check_in_time}{" "}
                {searchData?.data?.hotels_data?.check_in_time_period}
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 ">
              ...
              <div className="font-semibold">
                {searchData?.data?.hotels_data?.check_out_time}{" "}
                {searchData?.data?.hotels_data?.check_out_time_period}
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 ">
              ...
              <div className="">
                {" "}
                Age Limit {searchData?.data?.hotels_data?.child_policy}
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 ">
              ...
              <div className="">
                {searchData?.data?.hotels_data?.pet_policy}
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 ">
              ...
              <div className="">
                {searchData?.data?.hotels_data?.instruction}
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 ">
              ...
              <div className="flex">
                {searchData?.data?.hotels_data?.payment_methods?.map(
                  (payment_method) => (
                    <img
                      key={payment_method.id}
                      className="payment-method-icon"
                      src={payment_method?.url}
                    ></img>
                  )
                )}
          ...
          <div className="ratings-review-container" id="ratingReview">
            <div className="review-rating-division">
              <div className="font-semibold rating-title">
                {" "}
                Ratings & Review
              </div>
              <div className="flex space-x-2">
            ...
            <div className="service-rating">
              ...
              <div>Hotel Quality is Good</div>
              <button className="star-rating-btn">See More</button>
            </div>
          </div>
          ...
          <div className="map-section mt-[24px]">
            ...
            <div className="p-[24px] space-y-[10px]">
              ...
              <div className="flex space-x-1">
                <img className="map-icon" src={MapPin}></img>
                <div className="date">
                  3 hours 54 mins needed to reach Hotel Sea View
                </div>
              </div>
            </div>
          </div>
